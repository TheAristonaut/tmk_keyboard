...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(
      ...
      QUOT, SCLN,    L,    K,    J,    H, \
       ENT, SLSH,  DOT, COMM,    M,    N, \
         ...
         G,    F,    D,    S,    A, BSPC, \
         B,    V,    C,    X,    Z,  ESC, \
       FN2,  FN4,  SPC, LSFT, PAUS, \
      RGUI, LALT, LCTL,  FN3,  FN1 \
    ),
    /* 1: colemak */
    KEYMAP(
      BSLS,    P,    O,    I,    U,    Y, \
    ...
    /* 5: FN 3 and FN 4 */
    KEYMAP(
      BSLS,  F10,   F9,   F8,   F7, VOLU, \
      QUOT,  F11,   F6,   F5,   F4, VOLD, \
      TRNS,  F12,   F3,   F2,   F1, MUTE, \
         T,  END,   UP, HOME, PSCR,  FN0, \
         G, RGHT, DOWN, LEFT, SLCK,  DEL, \
         B, PGDN, PGUP,  INS, PAUS, TRNS, \
      TRNS, TRNS, TRNS, TRNS, TRNS, \
      TRNS, TRNS, TRNS, TRNS, TRNS \
    ),
// KEYMAP_ANSI(
...
const uint16_t PROGMEM fn_actions[] = {
    /* Poker Layout */
    [0] = ACTION_LAYER_MOMENTARY(3),  // Layout selector
    [1] = ACTION_LAYER_MOMENTARY(4),  // Sym thumbkey
    [2] = ACTION_LAYER_TOGGLE(4),     // Sym lock
    [3] = ACTION_LAYER_MOMENTARY(5),  // Fn thumbkey
    [4] = ACTION_LAYER_TOGGLE(5),     // Fn lock
